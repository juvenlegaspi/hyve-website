...
@section('content')
    ...
    >
        ...
        <div class="grid min-h-[42rem] overflow-hidden rounded-[1.3rem] border border-[#dfe7d8] bg-white shadow-[0_1rem_3rem_rgba(25,54,44,0.07)] lg:grid-cols-[22rem_minmax(0,1fr)]">
            <aside class="border-b border-[#e6ece1] lg:border-b-0 lg:border-r">
                <div class="border-b border-[#edf1e9] px-4 py-3">
                ...
                <div class="max-h-[36rem] overflow-y-auto" data-admin-support-list>
                    <div class="p-5 text-center text-[0.76rem] text-[#8a9187]">Loading conversations…</div>
                </div>
            </aside>

            <section class="flex min-h-[34rem] min-w-0 flex-col" data-admin-support-thread>
                ...
                <div class="hidden min-h-0 flex-1 flex-col" data-admin-support-active>
                    <header class="flex flex-wrap items-center justify-between gap-3 border-b border-[#e8ede4] px-4 py-3.5 sm:px-5">
                        <div>
                    ...
                    <div class="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto bg-[#fafbf7] p-4 sm:p-5" data-admin-support-messages></div>

                    <form class="border-t border-[#e5ebe0] bg-white p-3 sm:p-4" data-admin-support-reply-form>
