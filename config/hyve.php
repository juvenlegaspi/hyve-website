...
return [
    ...
    'spaces' => [
        [
            'title' => 'Common Area',
            'tag' => 'Open Workspace',
            'image' => 'images/common-area-1.png',
            'gallery' => [
                'images/common-area-1.png',
                'images/common-area-3.png',
                'images/common-area-4.png',
                'images/common-area-5.png',
                'images/common-area-10.png',
                'images/common-area-2.png',
                'images/common-area-7.png',
                'images/common-area-6.png',
                'images/common-area-8.png',
                'images/common-area-9.png',
                'images/common-area-11.png',
            ],
        ...
        [
            ...
            'image' => 'images/fortitude-2-seat-1.png',
            'gallery' => [
                'images/fortitude-2-seat-1.png',
                'images/fortitude-2-seat-2.png',
                'images/fortitude-2-seat-3.png',
                'images/fortitude-2-seat-4.png',
                'images/fortitude-2-seat-5.png',
            ],
        ...
        [
            ...
            'image' => 'images/room-7-four-seat-3.png',
            'gallery' => [
                'images/room-7-four-seat-3.png',
                'images/room-7-four-seat-1.png',
                'images/room-7-four-seat-2.png',
                'images/room-7-four-seat-4.png',
            ],
        ...
        [
            ...
            'image' => 'images/zeal-conference-room-1.png',
            'gallery' => [
                'images/zeal-conference-room-1.png',
                'images/zeal-conference-room-3.png',
                'images/zeal-conference-room-2.png',
                'images/zeal-conference-room-4.png',
                'images/zeal-conference-room-5.png',
            ],
